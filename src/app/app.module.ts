...
import { WorkshiftsComponent } from './admin/pages/Admin/job/workshifts/workshifts.component';
...
import { LocalizationComponent } from './admin/pages/Admin/configuration/localization/localization.component';
